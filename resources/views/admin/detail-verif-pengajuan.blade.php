              ...
              <form action="{{ route('simpan.pengajuan', $pengajuan->id) }}" method="POST" style="display: inline-block;">
                ...
                <div class="card-header card-no-border pb-0">
                  <div class="header-top">
                    <h4>Verifikasi Pengajuan Kerja Sama {{$media->name}}</h4>
                  </div>
                </div>
                      ...
                      <div class="mb-3">
                        <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                          ...
                          <div class="form-check radio radio-secondary">
                            <input class="form-check-input" id="radio22" type="radio" name="status" value="perbaikan" {{ ($pengajuan->status=="perbaikan")? "checked" : "" }}>
                            <label class="form-check-label" for="radio22">Perbaikan </label>
                          </div>
                        </div>
                      </div>
                    </div>
